...
public class TicketController {
	...
	@PostMapping("book")
	public ResponseEntity<TicketResource> bookTicket(@RequestBody BookTicketResource bookTicketResource) {

		log.info("Received Request to book ticket: " + bookTicketResource);

		return ResponseEntity.ok(ticketService.bookTicket(bookTicketResource));
	}
